...
import (
	...
	"github.com/wgmasvix-hue/ChengetAi-learn-/apps/school-service/internal/config"
	"github.com/wgmasvix-hue/ChengetAi-learn-/apps/school-service/internal/repositories"
	"github.com/wgmasvix-hue/ChengetAi-learn-/apps/school-service/internal/services"
...
func main() {
	...
	schoolRepo := repositories.NewSchoolRepository(dbPool)
