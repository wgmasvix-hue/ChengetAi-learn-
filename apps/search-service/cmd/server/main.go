...
import (
	...
	"github.com/wgmasvix-hue/ChengetAi-learn-/apps/search-service/internal/config"
	"github.com/wgmasvix-hue/ChengetAi-learn-/apps/search-service/internal/repositories"
...
func main() {
	...
	resourceRepo := repositories.NewResourceRepository(dbPool)
