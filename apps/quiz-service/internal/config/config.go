...
func Load() *Config {
	return &Config{
		ServiceName:          getEnv("SERVICE_NAME", "quiz-service"),
		Port:                 getEnvInt("SERVICE_PORT", 8010),
		...
		MaxQuestionCount:     getEnvInt("MAX_QUESTION_COUNT", 100),
		DefaultDifficulty:    getEnv("DEFAULT_DIFFICULTY", "medium"),
