...
type Config struct {
	...
	// Analytics
	RetentionDays         int    // Days to retain event data
	BatchSize             int    // Batch size for event processing
	ReportGenerationTime  string // Daily report generation time (HH:MM)
...
func Load() *Config {
	return &Config{
		...
		Port:               getEnvInt("SERVICE_PORT", 8012),
		...
		ReportGenerationTime: getEnv("REPORT_GENERATION_TIME", "00:00"),
